...
SOIL_THRESHOLDS: dict[str, list] = {
    ...
    "B": [
        # FIX: threshold corrected from 0.2 → 0.5 mg/kg.
        # ICAR and the Indian Coffee Board both define <0.5 mg/kg as deficient
        # for South Indian coffee.  The old 0.2 threshold was far too lenient —
        # it would have called B = 0.32 mg/kg "ADEQUATE" when it is in fact
        # deficient by field standards.
        (0.5,  "LOW — deficient (<0.5 mg/kg)", True),
        (None, "ADEQUATE (>=0.5 mg/kg)",       False),
    ],
}
